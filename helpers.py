...
from constants import ALLOWED_OPERANDS, ALLOWED_OPERATIONS, WORK_ITEM_NUMBER_PATTERN, GET_CURRENT_BRANCH_CMD, MAIN_BRANCH_NAME, BRANCH_NAME_PATTERN
...
def get_current_branch_name():
    return call_cmd(GET_CURRENT_BRANCH_CMD)
